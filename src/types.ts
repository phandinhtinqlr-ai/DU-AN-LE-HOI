...
export type ModuleType = 'Nhân sự' | 'Lễ hội' | 'Cảnh quan' | 'Bảo dưỡng';
...
export type StaffLevelType = 'Nhân viên' | 'Tổ phó' | 'Tổ trưởng' | 'Giám sát' | 'Chuyên viên' | 'Khác';
...
export interface Employee {
  ...
  staffLevel?: string; // Only for 'Nhân viên'
